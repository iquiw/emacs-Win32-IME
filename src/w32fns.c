...
static LRESULT w32_get_ime_reconversion_string (HWND, WPARAM, RECONVERTSTRING*);
...
#ifdef USE_W32_IME
  gui_default_parameter (f, parms, Qime_font, Qnil, "ime-font", "IME-Font", RES_TYPE_STRING);
#endif
}
